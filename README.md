...
## Sample Data
Explore our synthetic hospital discharge data with our downloadable dataset. This dataset contains synthetic patient records in the same format as administrative data available to healthcare organizations. Download the dataset here.
